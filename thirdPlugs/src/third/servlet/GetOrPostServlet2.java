 ...
 *
 */
public abstract class GetOrPostServlet2 extends DNAHttpServlet implements JsonFieldConstant{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		resp.setCharacterEncoding(CHARSET_UTF8);
		resp.setContentType(CONTENT_TYPE_JSON);
		ServletUtil.response2(resp, this.handle(req, resp));
	}
	 ...
	 * @return
	 */
	private final JSONArray handle(HttpServletRequest req,HttpServletResponse resp) {
		try {
	 ...
	 */
	protected abstract JSONArray handle(Context context, JSONObject parseContent) throws JSONException;
}